...
void VulkanRenderer::loadModel(const std::vector<Vertex3D>& vertices, 
    ...
    bufferManager.createVertexBuffer3D(vertices);
...
// NUEVA FUNCIÓN: Cargar modelo con nombre
...
// NUEVA FUNCIÓN: Renderizar múltiples objetos
...
// FUNCIÓN ACTUALIZADA: Grabar comandos para múltiples objetos
